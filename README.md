...
Upload an orchard image via the Streamlit interface. YOLOv8n detects all apples and draws bounding boxes with confidence scores.

![Upload and Detection](assets/screenshots/01_upload_detect.png)

### Step 2: Per-Apple Segmentation & Explainability
Click any detected apple to view its precise boundary mask generated by U-Net ResNet-34, along with fruit coverage metrics and dual XAI visualizations.

**Segmentation + XAI Panel (Fruit #5):**

![Segmentation and Explainability](assets/screenshots/02_segmentation_explainability.png)

**Detailed Explainability (Fruit #6):**

![Explainability Detail](assets/screenshots/03_explainability_detail.png)

### Step 3: Session Summary
The dashboard summarizes total detections and average fruit coverage across all apples in the image.

![Session Summary](assets/screenshots/04_summary.png)
